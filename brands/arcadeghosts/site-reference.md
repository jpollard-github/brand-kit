...
This file pulls the most useful ArcadeGhosts brand context into `brand-kit` so the generator work stays grounded in the live website identity.
...
When future generators are added or new brands are introduced, carry these inputs forward:
...
Good first extractions for this repo:
