export const arcadeghostsClientCollateral = {
  ...
  capability: {
    ...
    processDiagramExamples: [
      ["Spreadsheet", "Simple Web Tool", "Reports"],
  ...
  caseStudy: {
    ...
    intro:
      "A simple structure for showing the problem, the work, and the result in a concrete, client-friendly way.",
    sections: [
      {
        label: "Problem",
        prompt:
