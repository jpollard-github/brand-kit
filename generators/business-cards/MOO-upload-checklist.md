...
- `generators/business-cards/generator/README.md`
- `generators/business-cards/layout-spec.md`
- `generators/business-cards/layout-percentages.md`
- `https://www.moo.com/`
...
- `arcadeghosts.org/work-with-me` is easy to read
