...
<svg xmlns="http://www.w3.org/2000/svg" width="${documentSize.width}" height="${documentSize.height}" viewBox="0 0 ${documentSize.width} ${documentSize.height}">
  ...
  <text x="740" y="526" fill="${data.brand.palette.textMuted}" font-family="${data.fontStack}" font-size="42" font-weight="520">${collateral.positioning.primaryRole}</text>
  <text x="740" y="594" fill="${data.brand.palette.textMuted}" font-family="${data.fontStack}" font-size="36" font-weight="520">${collateral.positioning.shortPromise}</text>
  ...
  <text x="228" y="980" fill="#171b21" font-family="${data.fontStack}" font-size="36" font-weight="700" letter-spacing="6">CLIENT LETTERHEAD</text>
  <text x="228" y="1064" fill="#7d766d" font-family="${data.fontStack}" font-size="34" font-weight="520">Use this shell for proposals, follow-up notes, light statements of work, or written recommendations.</text>
  ...
  <text x="560" y="1310" fill="#7d766d" font-family="${data.fontStack}" font-size="44" font-weight="520">[Date]</text>
  ...
  <text x="228" y="1740" fill="#171b21" font-family="${data.fontStack}" font-size="64" font-weight="780">[Proposal, recommendation, or follow-up subject]</text>

  <text x="228" y="1950" fill="#3a342d" font-family="${data.fontStack}" font-size="42" font-weight="520">Hello,</text>
  <text x="228" y="2070" fill="#4d4640" font-family="${data.fontStack}" font-size="38" font-weight="520">Use this page for a practical client-facing message: a proposal intro, follow-up note, recommendation, scope summary, or short explanation of next steps.</text>
  <text x="228" y="2140" fill="#4d4640" font-family="${data.fontStack}" font-size="38" font-weight="520">The header keeps the document tied to the same brand system as the site and outreach materials while the body stays calm, readable, and print-friendly.</text>
  <text x="228" y="2280" fill="#4d4640" font-family="${data.fontStack}" font-size="38" font-weight="520">Replace this placeholder copy with client-specific text, practical recommendations, timeline notes, deliverables, or other details that move the conversation forward.</text>
  <text x="228" y="2420" fill="#4d4640" font-family="${data.fontStack}" font-size="38" font-weight="520">${collateral.positioning.oneLiner}</text>
  ...
  <text x="228" y="3098" fill="#7d766d" font-family="${data.fontStack}" font-size="30" font-weight="520">${data.brand.metadata.contactEmail} · ${data.displayUrl}</text>
</svg>`;
}
...
<svg xmlns="http://www.w3.org/2000/svg" width="${documentSize.width}" height="${documentSize.height}" viewBox="0 0 ${documentSize.width} ${documentSize.height}">
  ...
  <text x="688" y="506" fill="${data.brand.palette.textMuted}" font-family="${data.fontStack}" font-size="38" font-weight="520">${collateral.positioning.shortPromise}</text>
  ...
  <text x="1398" y="526" fill="#6f685f" font-family="${data.fontStack}" font-size="36" font-weight="520">[Client email]</text>

  <text x="1398" y="642" fill="#171b21" font-family="${data.fontStack}" font-size="34" font-weight="700" letter-spacing="5">DETAILS</text>
  <text x="1398" y="700" fill="#6f685f" font-family="${data.fontStack}" font-size="34" font-weight="520">Invoice #: [ID]</text>
  <text x="1784" y="700" fill="#6f685f" font-family="${data.fontStack}" font-size="34" font-weight="520">Date: [Date]</text>
  <text x="2188" y="700" text-anchor="end" fill="#6f685f" font-family="${data.fontStack}" font-size="34" font-weight="520">Due: [Due date]</text>
  ...
  <text x="278" y="1238" fill="#171b21" font-family="${data.fontStack}" font-size="42" font-weight="650">[Project or service line item]</text>
  <text x="278" y="1304" fill="#6f685f" font-family="${data.fontStack}" font-size="32" font-weight="520">[Short description of the work delivered.]</text>
  <text x="1480" y="1268" text-anchor="end" fill="#171b21" font-family="${data.fontStack}" font-size="38" font-weight="650">[Hours]</text>
  <text x="1750" y="1268" text-anchor="end" fill="#171b21" font-family="${data.fontStack}" font-size="38" font-weight="650">[Rate]</text>
  <text x="2236" y="1268" text-anchor="end" fill="#171b21" font-family="${data.fontStack}" font-size="38" font-weight="750">[Amount]</text>

  <rect x="228" y="1376" width="2094" height="186" rx="28" fill="#ffffff" stroke="rgba(15, 18, 24, 0.08)" stroke-width="2" />
  <text x="278" y="1466" fill="#171b21" font-family="${data.fontStack}" font-size="42" font-weight="650">[Project or service line item]</text>
  <text x="278" y="1532" fill="#6f685f" font-family="${data.fontStack}" font-size="32" font-weight="520">[Short description of the work delivered.]</text>
  <text x="1480" y="1496" text-anchor="end" fill="#171b21" font-family="${data.fontStack}" font-size="38" font-weight="650">[Hours]</text>
  <text x="1750" y="1496" text-anchor="end" fill="#171b21" font-family="${data.fontStack}" font-size="38" font-weight="650">[Rate]</text>
  <text x="2236" y="1496" text-anchor="end" fill="#171b21" font-family="${data.fontStack}" font-size="38" font-weight="750">[Amount]</text>

  <rect x="228" y="1604" width="2094" height="186" rx="28" fill="#ffffff" stroke="rgba(15, 18, 24, 0.08)" stroke-width="2" />
  <text x="278" y="1694" fill="#171b21" font-family="${data.fontStack}" font-size="42" font-weight="650">[Project or service line item]</text>
  <text x="278" y="1760" fill="#6f685f" font-family="${data.fontStack}" font-size="32" font-weight="520">[Short description of the work delivered.]</text>
  <text x="1480" y="1724" text-anchor="end" fill="#171b21" font-family="${data.fontStack}" font-size="38" font-weight="650">[Hours]</text>
  <text x="1750" y="1724" text-anchor="end" fill="#171b21" font-family="${data.fontStack}" font-size="38" font-weight="650">[Rate]</text>
  <text x="2236" y="1724" text-anchor="end" fill="#171b21" font-family="${data.fontStack}" font-size="38" font-weight="750">[Amount]</text>
  ...
  <text x="2236" y="2062" text-anchor="end" fill="${data.brand.palette.text}" font-family="${data.fontStack}" font-size="40" font-weight="720">[Subtotal]</text>
  ...
  <text x="2236" y="2168" text-anchor="end" fill="${data.brand.palette.text}" font-family="${data.fontStack}" font-size="40" font-weight="720">[Tax]</text>
  ...
  <text x="2236" y="2358" text-anchor="end" fill="${data.brand.palette.text}" font-family="${data.fontStack}" font-size="60" font-weight="800">[Total]</text>

  <text x="228" y="2072" fill="#171b21" font-family="${data.fontStack}" font-size="36" font-weight="700" letter-spacing="5">NOTES</text>
  <text x="228" y="2160" fill="#4d4640" font-family="${data.fontStack}" font-size="36" font-weight="520">Thank you for the opportunity to help. Replace these notes with any billing clarification, purchase-order detail, milestone context, or payment instruction the client actually needs.</text>
  <text x="228" y="2226" fill="#4d4640" font-family="${data.fontStack}" font-size="36" font-weight="520">Keep the invoice practical and trustworthy first. The branding should support clarity, not compete with it.</text>
  ...
  <text x="288" y="2724" fill="#6f685f" font-family="${data.fontStack}" font-size="32" font-weight="520">Replace with your real Stripe, ACH, check, or other payment instructions.</text>
